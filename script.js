...
const azkarData = {
    sabah: [
        { text: "أَصْبَحْنَا وأَصْبَحَ الْمُلْكُ لِلَّهِ وَالْحمْدُ لِلَّهِ", count: 1 },
        { text: "اللَّهُمَّ بكَ أَصْبَحْنَا وَبِكَ أَمْسَيْنَا وَبِكَ نحْيَا وَبِكَ نَمُوتُ وَإِليْكَ النُّشُورُ", count: 1 },
        { text: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ", count: 100 },
        { text: "لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ", count: 10 },
        { text: "اللَّهُمَّ صلِّ وَسَلِّمْ عَلَى نَبِيِّنا مُحَمَّدٍ", count: 10 },
    ],
    masa: [
        { text: "أمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ وَالْحَمْدُ لِلَّهِ", count: 1 },
        { text: "اللَّهُمَّ بِكَ أَمْسَيْنَا وَبِكَ أَصْبَحْنَا وَبِكَ نَحْيَا وَبِكَ نَمُوتُ وَإِلَيْكَ الْمَصِيرُ", count: 1 },
        { text: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ", count: 100 },
        { text: "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ منْ شَرِّ مَا خَلَقَ", count: 3 },
        { text: "اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ", count: 10 },
    ],
    nawm: [
        { text: "بِاسْمِكَ اللَّهمَّ أَمُوتُ وَأَحيَا", count: 1 },
        { text: "اللَّهُمَّ قِنِي عَذَابَكَ يَوْمَ تَبْعَثُ عبَادَكَ", count: 3 },
        { text: "سُبْحَانَ اللَّهِ", count: 33 },
        { text: "الْحَمْدُ لِلَّهِ", count: 33 },
        { text: "اللَّهُ أَكْبَرُ", count: 34 },
    ],
    istiqaz: [
        { text: "الْحَمْدُ لِلَّهِ الذِي أَحْيَانَا بَعْدَ مَا أَمَاتَنَا وَإلَيْهِ النُّشُورُ", count: 1 },
        { text: "لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ", count: 10 },
        { text: "سُبْحَانَ اللَّهِ وَبِحَمْدِهِ", count: 10 },
        { text: "أَسْتغْفِرُ اللَّهَ الْعَظِيمَ وَأَتُوب إِلَيْهِ", count: 3 },
    ],
};
...
const ayahHadithList = [
    { type: "آية كريمة", text: "أَلَا بِذكْرِ اللَّهِ تَطْمَئِنُّ الْقُلُوبُ" },
    { type: "آية كريمة", text: "فَاذْكُرُونِي أَذْكُرْكمْ وَاشْكُرُوا لِي وَلَا تَكْفُرُونِ" },
    { type: "آية كريمة", text: "إِنَّ مَع الْعُسْرِ يُسْرًا" },
    { type: "آية كريمة", text: "وَمَن يَتَّقِ اللَّهَ يجْعَل لَّهُ مَخْرَجًا" },
    { type: "آية كريمة", text: "حَسْبُنَا اللَّهُ وَنِعْمَ الْوكِيلُ" },
    { type: "حديث شريف", text: "الدُّعَاءُ هُوَ الْعِبَادَةُ" },
    { type: "حديث شريف", text: "الكَلِمَةُ الطَّيِّبَةُ صَدَقَةٌ" },
    { type: "حديث شريف", text: "خَيْرُكمْ مَنْ تَعَلَّمَ الْقرْآنَ وَعَلَّمَهُ" },
    { type: "حديث شريف", text: "الْمُسْلِمُ مَنْ سَلِمَ الْمُسْلِمُونَ مِنْ لِسَانهِ وَيَدِهِ" },
    { type: "حديث شريف", text: "منْ لَمْ يَرْحَمْ لَا يُرحَمْ" },
];
